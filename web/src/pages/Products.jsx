...
const fallbackProducts = [
  ...
  {
    id: 1062,
    name: "Red Rice Flour 2kg",
    category: "Flour",
    price: "800.00",
    wholesale_price: "680.00",
    unit: "2kg",
    description: "Premium quality Red Rice Flour 2kg (சிவப்பு அரிசி மா)",
    features: [
      "Premium Quality",
      "Traditional Taste",
      "Wholesale Rate: LKR 680",
    ],
    image_url: "/assets/red_rice_flour_2kg.jpg",
...
const Products = () => {
  ...
  const filteredProducts = (products || []).filter((item) => {
    ...
    if (!matchesCategory) {
      ...
      if (
        sel === "rice flour" &&
        (cat.includes("rice") || cat.includes("flour"))
      )
        matchesCategory = true;
      else if (sel === "gingelly oil" && cat.includes("oil"))
        matchesCategory = true;
      else if (
        sel === "spices" &&
        (cat.includes("spice") ||
        ...
        matchesCategory = true;
      else if (cat === sel || cat.includes(sel) || sel.includes(cat))
        matchesCategory = true;
    }
  ...
  filteredProducts.sort((a, b) => {
    ...
    const idxA = categoryOrder.findIndex((c) => catA.includes(c.toLowerCase()));
    const idxB = categoryOrder.findIndex((c) => catB.includes(c.toLowerCase()));
    ...
    >
      ...
      >
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          <h1
            style={{
              fontSize: "clamp(1.5rem, 5.5vw, 3.4rem)",
              fontWeight: "900",
              marginBottom: "16px",
              color: "#FFFFFF",
              ...
              {categories.map((cat) => (
                <button
                  ...
                  style={{
                    ...
                    backgroundColor:
                      selectedCategory === cat ? "#0F4A24" : "#F1F5F9",
          ...
          >
            {filteredProducts.map((product) => {
              ...
              const totalPrice = product.price
                ...
                : "0.00";
              const realPrice = product.wholesale_price
                ? (parseFloat(product.wholesale_price) * qty).toFixed(2)
                : totalPrice;
              ...
              const getTamilName = (p) => {
                ...
                if (
                  ...
                  return "சிவப்பு அரிசி மாவு";
                if (name.includes("gingelly oil"))
              ...
              const getProductImage = (p) => {
                ...
                if (
                  ...
                  slug === "red-raw-rice-5kg" ||
                  url.includes("red_raw_rice_5kg")
                )
                  return redRawRice5kgImg;
                if (
                  name.includes("flour 25kg") ||
                  slug === "red-rice-flour-25kg" ||
                  url.includes("flour_25kg")
                )
                  return redRice25kgImg;
                if (
                  name.includes("flour 10kg") ||
                  slug === "red-rice-flour-10kg" ||
                  url.includes("flour_10kg")
                )
                  return redRice10kgImg;
                if (
                  name.includes("flour 5kg") ||
                  slug === "red-rice-flour-5kg" ||
                  url.includes("flour_5kg")
                )
                  return redRice5kgImg;
                if (
                  name.includes("flour 2kg") ||
                  slug === "red-rice-flour-2kg" ||
                ...
                if (
                  ...
                  return gingellyOil750mlImg;
                if (
                  name.includes("375ml") ||
                  slug === "gingelly-oil-375ml" ||
                  url.includes("375ml")
                )
                  return gingellyOil375mlImg;
                          ...
                          {product.wholesale_price ? (
                            <>
                              ...
                              >
                                LKR{" "}
                                {(
                                  parseFloat(product.wholesale_price) * qty
                                ).toFixed(2)}
                              </div>
                              <div
                                style={{
