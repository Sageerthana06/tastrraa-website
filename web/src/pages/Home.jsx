...
const floatingProducts = [
  { id: 'prod-1', img: redRice5kgImg, size: 350, startX: 5, startY: 15, delay: 0, duration: 40 },
  { id: 'prod-2', img: gingellyOil750mlImg, size: 280, startX: 75, startY: 10, delay: -10, duration: 35 },
  { id: 'prod-3', img: roastedChilli50gImg, size: 320, startX: -5, startY: 65, delay: -20, duration: 45 },
  { id: 'prod-4', img: masalaMurukkuImg, size: 400, startX: 65, startY: 70, delay: -5, duration: 50 },
  { id: 'prod-5', img: bengalGramPackImg, size: 250, startX: 40, startY: 40, delay: -15, duration: 30 },
  { id: 'prod-6', img: redRice2kgImg, size: 200, startX: 85, startY: 45, delay: -25, duration: 38 },
];
    ...
    <div style={{ overflowX: 'hidden', backgroundColor: '#FAF9F5', position: 'relative' }}>
      ...
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, zIndex: 1, overflow: 'hidden', pointerEvents: 'none' }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(-45deg, rgba(239,68,68,0.08), rgba(245,158,11,0.08), rgba(16,185,129,0.08), rgba(180,83,9,0.08))',
          backgroundSize: '400% 400%',
          animation: 'vibrant-shift 20s ease infinite',
        }} />
        ...
        {floatingProducts.map((prod, i) => (
          <motion.div
            key={prod.id}
            animate={{
              x: mousePos.x * 80 * (i % 2 === 0 ? 1 : -1),
              y: mousePos.y * 80 * (i % 2 === 0 ? 1 : -1),
            }}
            transition={{ type: 'spring', stiffness: 30, damping: 20 }}
            style={{ position: 'absolute', top: `${prod.startY}%`, left: `${prod.startX}%` }}
          >
            <motion.img
              src={prod.img}
              ...
              style={{
                ...
                height: `${prod.size}px`,
                objectFit: 'contain',
                opacity: 0.12, // Subtle opacity so it doesn't block text
                filter: 'blur(4px) drop-shadow(0 20px 30px rgba(0,0,0,0.2))',
              }}
            />
          </motion.div>
        ))}
